...
import { getMedicines, triggerRefillAlert } from '../utils/api';
...
export default function RefillAlerts() {
  ...
  useEffect(() => {
    getMedicines()
      .then(res => {
        const meds = res.data || [];
        setLowStock(meds.filter(m => m.stock < 100));
      })
      .catch(() => {
        setLowStock([
          { _id: 'm1', name: 'Amoxicillin 500mg', stock: 0, price: 8500 },
          { _id: 'm2', name: 'Lisinopril 10mg', stock: 85, price: 12000 },
          { _id: 'm3', name: 'Sertraline 50mg', stock: 95, price: 19000 },
        ]);
      });
  }, []);
